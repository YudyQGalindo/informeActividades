...
from tasks.views import Inicio, InicioAdminListView, SignInView, SignOutView, UserTasksListView, TaskUpdateView, TaskCompleteView, TaskDeleteView, TaskCreateView, UserCompletedTasksListView, UsersDetailView, UserUpdateView, UserDeleteView, SignupView, reportTasks, GeneratePDFView

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', Inicio.as_view(), name='index'),
    path('tasks/', UserTasksListView.as_view(), name='tasks'),
    path('reportTasks/', reportTasks.as_view(), name='reportTasks'),
